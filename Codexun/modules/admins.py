...
async def pause(_, message: Message):
    ...
    await message.reply_text(
        f"🎧 __**تم إيقاف الدردشة الصوتية مؤقتًا**__\n│\n╰ من {checking}!"
    )
...
async def resume(_, message: Message):
    ...
    if not await is_active_chat(chat_id):
        ...
        await message.reply_text(
            f"🎧 __**تم استئناف المحادثة الصوتية**__\n│\n╰ استئناف الموسيقى من {checking}!"
        )
...
async def stop(_, message: Message):
    ...
    if await is_active_chat(chat_id):
        ...
        await message.reply_text(
            f"🎧 __**تم ايقاف المحادثة الصوتية/Stopped**__\n│\n╰ تم ايقاف الموسيقى من {checking}!"
        )
    else:
        return await message.reply_text(
            "لا شيء مشغل."
...
async def skip(_, message: Message):
    ...
    if not await is_active_chat(chat_id):
        ...
        if is_empty(chat_id):
            ...
            await message.reply_text(
                f"⏭ __**تم التخطي إلى الأغنية التالية.**__\n│\n╰ تم تخطي الموسيقى من {checking}"
            )
